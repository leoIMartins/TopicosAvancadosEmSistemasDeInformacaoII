...
namespace VendaIngressos.Controllers
{
    ...
    public class TimesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeTime,Tecnico")] Time time)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeTime,Tecnico")] Time time)
        {
            if (id != time.Id)
            {
                return NotFound();
